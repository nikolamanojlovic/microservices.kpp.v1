...
import { dokumentReducer } from './dokument/reducer';
...
import { DokumentAkcije } from './dokument/tipovi';
...
export type AkcijeAplikacije = KorisnikAkcije | PorukaAkcije | ProcesAkcije | DokumentAkcije;
